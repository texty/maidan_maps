...
$('#one').waypoint(function(direction) {
  ...
  if (direction === 'up') {
      playVideo("https://texty.org.ua/video/maidan_maps/maidan-bg-blacked.mp4", "Відео Влада Казакова")
...
$('#seven').waypoint(function(direction) {
  ...
  if (direction === 'down') {
    ...
    playVideo("https://texty.org.ua/video/maidan_maps/mariinka-start.mp4", "Початок протистояння в Маріїнському парк. Відео Денис Артемєв", "img/minimap-mariinka-start.png");
  } else if (direction === 'up') {
    stopVideo();
...
$('#thirteen').waypoint(function(direction) {
  if (direction === 'down') {
    playVideo("https://texty.org.ua/video/maidan_maps/grushevskogo9.mp4", "Тітушки та силовики добивають поранених протестувальників біля будинку №9 на вул. Грушевського. Відео Oleg V.", "img/minimap-grushevskogo9.png"); 
  } else if (direction === 'up') {
    stopVideo();
  }
},{ offset: 50 });
...
$('#fifteen').waypoint(function(direction) {
  if (direction === 'down') {
    playVideo("https://texty.org.ua/video/maidan_maps/gas-kriposnyi.mp4", "Леонід Бібік намагається розчистити дорогу за допомогою міліцейського ГАЗу. Відео Павла Кучера", "img/minimap-gas-kriposnyi.png"); 
  } else if (direction === 'up') {
    stopVideo();
  }
},{ offset: 50 });
...
$('#nineteen').waypoint(function(direction) {
  if (direction === 'down') {
    playVideo("https://texty.org.ua/video/maidan_maps/shovkovychna.mp4", "Протистояння на перехресті Інститутська-Шовковична. Відео Максима Кудимця", "img/minimap-shovkovychna.png"); 
  } else if (direction === 'up') {
    stopVideo(); 
  }
},{ offset: 10 });
...
$('#twenty-seven').waypoint(function(direction) {
  if (direction === 'down') {
    playVideo("https://texty.org.ua/video/maidan_maps/btrs.mp4", "БТРи таранять барикади. Відео Accidents news", "img/minimap-btrs.png"); 
  } else if (direction === 'up') {
    stopVideo(); 
    animateFly(map_center, zoom_size, 0, 0);
  }
...
$('#thirty-four').waypoint(function(direction) {
  if (direction === 'down') {
    playVideo("https://texty.org.ua/video/maidan_maps/anthem-18.mp4", "Штурм барикад 18 лютого. Відео BABYLON'13", "img/minimap-anthem.png"); 
  } else if (direction === 'up') {
    stopVideo(); 
  }
},{ offset: 100 });
...
$('#thirty-nine').waypoint(function(direction) {
  if (direction === 'down') {
    playVideo("https://texty.org.ua/video/maidan_maps/unions-fire.mp4", "Порятунок протестувальників з будинку профспілок. Відео BABYLON'13", "img/minimap-unions-fire.png"); 
  } else if (direction === 'up') {
    stopVideo(); 
...
$('#forty-three').waypoint(function(direction) {
   if (direction === 'down') {
    playVideo("https://texty.org.ua/video/maidan_maps/explosions-18.mp4", "Палаючі барикади. Відео BABYLON'13", "img/minimap-explosions-18.png"); 
  } else if (direction === 'up') {
    stopVideo(); 
    map.setFilter('fights', [ "in", 'time', 2100, 190100 ]);
  }
...
$('#forty-six').waypoint(function(direction) {
  if (direction === 'down') {
    map.setFilter('fights', [ "in", 'time', 2100 ]);
    playVideo("https://texty.org.ua/video/maidan_maps/day-19.mp4", "Ранок на Майдані 19 лютого. Відео BABYLON'13", "img/minimap-day-19.png");  
  } else if (direction === 'up') {
     stopVideo();  
    $(".mapboxgl-popup").remove();
    morph("geo190300", ["maidan", "berkut"]);
...
$('#fifty').waypoint(function(direction) {
  if (direction === 'down') {
    playVideo("https://texty.org.ua/video/maidan_maps/explosion-20.mp4", "Майдан намагається повернути позиції. Між 8 та 9 ранку 20 січня. Відео Maidan18-20 History", "img/minimap-explosion-20.png");  
  } else if (direction === 'up') {
     stopVideo();  
  }
},{ offset: 50 });
...
$('#fifty-six').waypoint(function(direction) {
  if (direction === 'down') {
    playVideo("https://texty.org.ua/video/maidan_maps/retreat-20.mp4", "Відступ силовиків до урядового кварталу ~9:10 20 січня. Відео Maidan18-20 History", "img/minimap-retreat-20.png");  
  } else if (direction === 'up') {
     stopVideo();  
     morph("geo200905", ["maidan", "berkut","chorna-rota"]);
  }
...
$('#sixty-two').waypoint(function(direction) {
  $(".mapboxgl-popup").remove();
  if (direction === 'down') {
    playVideo("https://texty.org.ua/video/maidan_maps/instytutska-0913.mp4", "Снайпери з жовтими пов'язками стріляють в натовп. ~9:13 20 лютого. Відео ютуб-каналу «Виновных покарают»", "img/minimap-instytutska-0913.png");  
  } else if (direction === 'up') {
     stopVideo();  
  }
},{ offset: 50 });
...
$('#sixty-seven').waypoint(function(direction) {
  $(".mapboxgl-popup").remove();
  if (direction === 'down') {
    playVideo("https://texty.org.ua/video/maidan_maps/instytutska-0922.mp4", "Смерть Андрія Дигдаловича, 09:22:51 20 лютого. Відео BABYLON'13", "img/minimap-instytutska-0922.png");  
  } else if (direction === 'up') {
     stopVideo(); 
     map.setFilter('fights', [ "in", 'time', 2100, 200900, 200910 ]);
     animateFly([30.523568,50.449962], zoom_size*1.1, 10, 10);
...
$('#seventy-four').waypoint(function(direction) {
  ...
  if (direction === 'down') {
     ...
     playVideo("https://texty.org.ua/video/maidan_maps/instytutska-1001.mp4", "Eпіцентр розстрілів, ~10:01 20 лютого. Відео Тараса Макаренко", "img/minimap-instytutska-1001.png");  
  } else if (direction === 'up') {
     stopVideo();  
